...
router.get("/", verifyToken, allowRoles("admin", "faculty", "manager", "student"), checkManagerPermission("subjects.read", ["fees", "attendance", "reports", "timetable", "exams", "classes"]), subjectController.getAllSubjects);
router.get("/:id", verifyToken, allowRoles("admin", "faculty", "manager"), checkManagerPermission("subjects.read", ["fees", "attendance", "reports", "timetable", "exams", "classes"]), subjectController.getSubjectById);
